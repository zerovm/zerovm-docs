...
If you ever need to kill/restart DevStack (as is the case if you modify
ZeroCloud code or change Swift configuration settings), first log in to the
vagrant box:
...
Subsequent restarts are easier. Run ``./rejoin-stack.sh`` as above, press
